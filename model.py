...
class Model:
    ...
    def run(self, t_simulation):
        ...
        # Store noisy deviations for later use. Minimum 2 noisy Gaussian-mean deviations per interaction.
...
if __name__=="__main__":
    ...
    resolution = "SA"
    ic = "2G-6AM"
    for noise_type in  ["ambiguityNoise", "selectionNoise", "exogenousNoise", "adaptationNoise"]:
